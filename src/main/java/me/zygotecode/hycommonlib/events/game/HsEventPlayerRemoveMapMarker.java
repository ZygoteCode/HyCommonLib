...
public class HsEventPlayerRemoveMapMarker extends HsEventCancellable {
    private PacketHandler packetHandler;
    private Packet packet;
    private String markerId;

    public HsEventPlayerRemoveMapMarker(PacketHandler packetHandler, Packet packet, String markerId) {
