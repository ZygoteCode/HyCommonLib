...
public class HsEventPlayerPreCraftRecipe extends HsEventCancellable {
    ...
    public HsEventPlayerPreCraftRecipe(ArchetypeChunk<EntityStore> archetypeChunk, Store<EntityStore> store, CommandBuffer<EntityStore> commandBuffer, HsPlayer player, CraftingRecipe craftingRecipe, int quantity) {
