...
public class HsEventPlayerDropItem extends HsEventCancellable {
    ...
    public HsEventPlayerDropItem(ArchetypeChunk<EntityStore> archetypeChunk, Store<EntityStore> store, CommandBuffer<EntityStore> commandBuffer, HsPlayer player, ItemStack itemStack, float throwSpeed) {
