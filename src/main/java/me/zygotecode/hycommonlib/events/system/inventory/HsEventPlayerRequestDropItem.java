...
public class HsEventPlayerRequestDropItem extends HsEventCancellable {
    ...
    public HsEventPlayerRequestDropItem(ArchetypeChunk<EntityStore> archetypeChunk, Store<EntityStore> store, CommandBuffer<EntityStore> commandBuffer, HsPlayer player, int inventorySectionId, short slotId) {
