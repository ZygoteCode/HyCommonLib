...
public class HsEventPostUseBlock extends HsEventCancellable {
    ...
    public HsEventPostUseBlock(ArchetypeChunk<EntityStore> archetypeChunk, Store<EntityStore> store, CommandBuffer<EntityStore> commandBuffer, BlockType blockType, Vector3i targetBlock, InteractionContext context, InteractionType interactionType, HsPlayer player) {
